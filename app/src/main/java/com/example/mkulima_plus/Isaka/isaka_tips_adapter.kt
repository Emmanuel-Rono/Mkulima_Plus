...
class isaka_tips_adapter(val context: Context, val attacks:List<Isaka_DataClass>)
    :RecyclerView.Adapter<isaka_tips_adapter.isaka_viewholder>()
{
    ...
    {
        val view=
            LayoutInflater.from(parent.context).inflate(R.layout.tips_layout,parent,false)
